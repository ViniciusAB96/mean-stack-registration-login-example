(function () {
    ...
    function Service($http, $q) {
        ...
        service.GetByTitulo = GetByTitulo;
        ...
        function GetByTitulo(pergunta) {
            return $http.get('/api/users/' + pergunta).then(handleSuccess, handleError);
        }

        function Create(pergunta) {
            return $http.post('/api/perguntaRegister', pergunta).then(handleSuccess, handleError);
        }
